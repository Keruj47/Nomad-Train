...
#Multiplying train's coordinates by 8
...
#Killing previous nt.worldborder_center_marker markers and spawning one
...
#Killing all nt.worldborder_center_marker markers and removing forceload from all chunks
kill @e[nbt={Tags:["nt.worldborder_center_marker"]}]
